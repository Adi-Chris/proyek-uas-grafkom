...
public class SkyboxRenderer extends Object {
    ...
    public int loadCubeMap(String[]textureFiles){
        ...
        for (int i=0;i<textureFiles.length;i++){
            TextureData data = decodeTextureFile("C:\\Users\\ADI CHRISTIAN\\OneDrive\\Documents\\Tugas-Tugas Kuliah\\Grafika Komputer\\ProyekUASGrafkom\\src\\main\\resources\\res\\" + textureFiles[i] + ".png");
